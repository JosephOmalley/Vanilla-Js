// creates an object to keep track of the values inputed
const Calculator = {
    ...
    // this will hold the actual operator: null,
    operator: null,
} ;

//this function changes the calues every time a button is click
function Input_Digit(digit) {
    const { Display_Value, wait_Second_Operand } = Calculator;
    /* this ensures that Wait_Second_Operand is true and has and set
...
function Input_Decimal(dot) {
    //this prevents bug if the decimal button is accidentally clicked 
